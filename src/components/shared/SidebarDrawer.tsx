...
import { Newspaper, Favorite, History, AddOutlined, People, ArticleOutlined } from '@mui/icons-material';
...
const Sidebar: React.FC<SidebarProps> = ({ handleDrawerClose, open }) => {
    ...
    const adminTabs: ITab[] = [
        ...
        {
            label: "Gestion Journaux",
            path: "/management/newspapers",
            icon: <Newspaper />
        },
    ]
